...
PanelWindow {
    ...
    Item {
        ...
        x: -background.slidingFactor * parent.width * 0.02
    ...
    Item {
        width: childrenRect.width
        height: parent.height
        x: -background.slidingFactor * parent.width * 0.06
    ...
    Item {
        width: childrenRect.width
        height: parent.height
        x: -background.slidingFactor * parent.width * 0.4
        y: -295 * background.scalingFactor
        Behavior on x {
            WorkspaceAnimation {}
        }
        Repeater {
    ...
    Item {
        width: childrenRect.width
        height: parent.height
        x: -background.slidingFactor * parent.width * 0.7
        y: 112 * background.scalingFactor
        Behavior on x {
            WorkspaceAnimation {}
        }
        Repeater {
